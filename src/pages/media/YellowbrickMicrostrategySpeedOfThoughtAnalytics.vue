...
export default {
  metaInfo: {
    title: 'Speed-of-thought Analytics',
    meta: [
      {
				key: 'description',
				name: 'description',
        content: 'Yellowbrick and Microstrategy query billions of rows in milliseconds to highlight speed-of-thought analytics.'
      }
    ]
  }
}
