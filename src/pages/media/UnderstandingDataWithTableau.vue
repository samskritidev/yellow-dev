...
export default {
  metaInfo: {
    title: 'Understanding Yellowbrick Data with Tableau',
    meta: [
      {
				key: 'description',
				name: 'description',
				content: 'Yellowbrick Data and Tableau - a powerful combination.' }
    ]
  }
}
</script>