...
<template>
	...
	<section class="hero py-20">
		<div class="w-full max-w-1200 mx-auto text-white z-10">
			<h1>How Yellowbrick Integrates into Existing Environments</h1>
		</div>
	</section>

	<section class="bg-white py-12 md:py-20 z-10">
		<div class="w-full max-w-1200 mx-auto">
			<BaseWistia id="drudmykyg4" />
		</div>
	</section>
...
export default {
  metaInfo: {
    title: 'Yellowbrick Integrates Into Existing Environments',
    meta: [
      {
				key: 'description',
				name: 'description',
				content: 'Yellowbrick Data Warehouse can fit into existing environments.' }
    ]
  }
}
</script>