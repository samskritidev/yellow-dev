...
export default {
  metaInfo: {
    title: 'Query billions of JSON and XML documents in seconds.',
    meta: [
      {
				key: 'description',
				name: 'description',
        content: 'Yellowbrick and Sonra query billions of JSON and XML in seconds.'
      }
    ]
  }
}
